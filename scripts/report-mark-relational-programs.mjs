...
const world=await readVerified(worldPath,"mark_relational_program_world_blind_v1"),evaluation=await readVerified(evalPath,"mark_relational_transfer_evaluation_blind_v1"),rejoin=JSON.parse(await fs.readFile(rejoinPath,"utf8"));
...
const report={
  schema:"mark_relational_program_context_report_v1",generatedAt:new Date().toISOString(),sealedWorldSha256:world.blindSha256,sealedEvaluationSha256:evaluation.blindSha256,
